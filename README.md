...
Keep the source folders and files:
...
Generated runtime folders like `instance/`, `tests_runtime/`, `.pytest_tmp/`, `__pycache__/`, and temporary pytest cache folders are not required for submission.
